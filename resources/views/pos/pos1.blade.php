...
<body>
    ...
    <div class="row " style="height: 100vh; margin:0; overflow:hidden; background:rgb(194, 194, 194);">
        <div class="col-4 h-100 d-flex flex-column" style="background:#fff;">
        ...
        <div class="col-5 h-100 d-flex flex-column" style="background:#fff;">
            <div class="row pt-1 g-1" style="height: 100px;">
                ...
                <div class="col-6">
                    <select name="item" class="selectize" placeholder="Search Item (F8)">
